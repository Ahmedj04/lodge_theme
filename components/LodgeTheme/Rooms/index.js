...
function Rooms({rooms }) {
    // console.log(rooms?.rooms[0].room_images[0]?.image_link)
    return (
        <section>
            <div className='py-10 md:py-20 lg:py-36 px-5 lg:px-28 lg:mx-24'>
                <div>
                    {/* room heading */}
                    <div className='mb-5 md:mb-10 text-center'>
                        <div>
                            <h2 className='text-4xl lg:text-6xl text-slate-600'> OUR ROOMS</h2>
                        </div>
                    </div>
                                ...
                                <div className='md:my-5 lg:my-12 md:flex text-center md:text-start'>
                                    ...
                                    <div className='md:w-6/12'>
                                        <div className='p-5 md:px-16 md:py-0 lg:px-10'>
                                            ...
                                            <div className='mb-5'>
                                                <div>
                                                    <h5 className='text-xl lg:text-2xl text-slate-600 font-normal'>{room?.room_name}</h5>
                                                </div>
                                            </div>
                                            ...
                                            <div className='mb-5'>
                                                <div>
                                                    <p className='text-sm lg:text-base text-slate-500'>{room?.room_description}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <ul>
                                                    <li className='flex justify-center md:justify-start text-slate-500'>
                                    ...
                                    <div className='mb-5 md:my-auto md:w-3/12'>
                                        <div>
                                            {room?.unconditional_rates?.map((resource, index) => {
                                                return <h6 key={index} className="text-lg md:text-base text-slate-500 ">FROM {resource?.baserate_currency + " " + resource?.baserate_amount}</h6>
                                            })}
                                        </div>
